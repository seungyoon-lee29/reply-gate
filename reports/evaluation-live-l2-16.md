...
- 실행 시각(UTC): `2026-08-19T08:33:29+00:00`
- 생성 LLM: 미실행
- 임베딩: 미실행
...
| `judge_effort` | 기본값 |  |
| `judge_prompt_version` | judge-7fad677f9ac6 | **선언된 실험 변인** |
...
선언된 실험 변인: `judge_prompt_version`, `judge_fixture_version`
...
- **L2 검출률: 100.0%** (6/6)
- **L2 오탐률: 0.0%** (0/5)
- 사유 목록까지 정확히 일치: 100.0% (11/11)
- claim 단위 판정 일치: 100.0% (19/19)
- 모순 근거쌍: 기대 4건 중 4건 검출 (기대 밖 검출 0건)
- 판정 토큰: 입력 32814 / 출력 6845 (픽스처당 3605.4)
...
| `contradictory_evidence` | 3 | 3 | 100.0% | 0 |

모든 픽스처가 기대 판정·기대 사유 목록과 일치했다.

## 회귀 가드 — 이중 기준선 두 줄 보고

- 이번 실측 세트: 1/3회 `evaluation-live-l2-16`
  - 조건 불일치로 세트에서 제외: `evaluation-live-l2-15` — 조건이 다르다: judge_prompt_version: 기준선 `judge-7fad677f9ac6` → 이번 `judge-e26f6c8e0b84` · `evaluation-live-l2-14` — 조건이 다르다: judge_prompt_version: 기준선 `judge-7fad677f9ac6` → 이번 `judge-e26f6c8e0b84` · `evaluation-live-l2-13` — 조건이 다르다: judge_prompt_version: 기준선 `judge-7fad677f9ac6` → 이번 `judge-e26f6c8e0b84` · `evaluation-live-l2-12` — 조건이 다르다: judge_prompt_version: 기준선 `judge-7fad677f9ac6` → 이번 `judge-e26f6c8e0b84` · judge_fixture_version: 기준선 `fixture-2b8f33392b36` → 이번 `fixture-836322e97320` · measurement_scope: 기준선 `measurement_1_3_only` → 이번 `full` · `evaluation-live-l2-11` — 조건이 다르다: judge_prompt_version: 기준선 `judge-7fad677f9ac6` → 이번 `judge-e26f6c8e0b84` · judge_fixture_version: 기준선 `fixture-2b8f33392b36` → 이번 `fixture-836322e97320` · measurement_scope: 기준선 `measurement_1_3_only` → 이번 `full` · `evaluation-live-l2-10` — 조건이 다르다: judge_prompt_version: 기준선 `judge-7fad677f9ac6` → 이번 `judge-e26f6c8e0b84` · judge_fixture_version: 기준선 `fixture-2b8f33392b36` → 이번 `fixture-836322e97320` · measurement_scope: 기준선 `measurement_1_3_only` → 이번 `full` · `evaluation-live-l2-6` — 조건이 다르다: acceptance_cut: 기준선 `0.3` → 이번 `0.5` · `evaluation-live-l2-5` — 조건이 다르다: acceptance_cut: 기준선 `0.3` → 이번 `0.5` · `evaluation-live-l2-4` — 조건이 다르다: acceptance_cut: 기준선 `0.3` → 이번 `0.5` · `evaluation-live-l2-3` — 조건 지문이 확인되지 않는다(미상 11개: label_version, retrieval_labels_version, abstention_gate_statistic 외 8개) · `evaluation-live-l2-2` — 조건 지문이 확인되지 않는다(미상 11개: label_version, retrieval_labels_version, abstention_gate_statistic 외 8개) · `evaluation-live-l2-1` — 조건 지문이 확인되지 않는다(미상 11개: label_version, retrieval_labels_version, abstention_gate_statistic 외 8개)
...
- 선언된 실험 변인(대조 진행): judge_prompt_version: 기준선 `judge-e26f6c8e0b84` → 이번 `judge-7fad677f9ac6` · judge_fixture_version: 기준선 `fixture-836322e97320` → 이번 `fixture-2b8f33392b36`
- 참고: 선언된 실험 변인이 있어 대조를 진행한다 — 차이: judge_prompt_version: 기준선 `judge-e26f6c8e0b84` → 이번 `judge-7fad677f9ac6` · judge_fixture_version: 기준선 `fixture-836322e97320` → 이번 `fixture-2b8f33392b36`
...
- 사유: 판정 보류 — 조건이 확인된 실측 1/3 — 세트가 아직 안 찼다 (조건 불일치로 제외: `evaluation-live-l2-15` — 조건이 다르다: judge_prompt_version: 기준선 `judge-7fad677f9ac6` → 이번 `judge-e26f6c8e0b84` · `evaluation-live-l2-14` — 조건이 다르다: judge_prompt_version: 기준선 `judge-7fad677f9ac6` → 이번 `judge-e26f6c8e0b84` · `evaluation-live-l2-13` — 조건이 다르다: judge_prompt_version: 기준선 `judge-7fad677f9ac6` → 이번 `judge-e26f6c8e0b84` · `evaluation-live-l2-12` — 조건이 다르다: judge_prompt_version: 기준선 `judge-7fad677f9ac6` → 이번 `judge-e26f6c8e0b84` · judge_fixture_version: 기준선 `fixture-2b8f33392b36` → 이번 `fixture-836322e97320` · measurement_scope: 기준선 `measurement_1_3_only` → 이번 `full` · `evaluation-live-l2-11` — 조건이 다르다: judge_prompt_version: 기준선 `judge-7fad677f9ac6` → 이번 `judge-e26f6c8e0b84` · judge_fixture_version: 기준선 `fixture-2b8f33392b36` → 이번 `fixture-836322e97320` · measurement_scope: 기준선 `measurement_1_3_only` → 이번 `full` · `evaluation-live-l2-10` — 조건이 다르다: judge_prompt_version: 기준선 `judge-7fad677f9ac6` → 이번 `judge-e26f6c8e0b84` · judge_fixture_version: 기준선 `fixture-2b8f33392b36` → 이번 `fixture-836322e97320` · measurement_scope: 기준선 `measurement_1_3_only` → 이번 `full` · `evaluation-live-l2-6` — 조건이 다르다: acceptance_cut: 기준선 `0.3` → 이번 `0.5` · `evaluation-live-l2-5` — 조건이 다르다: acceptance_cut: 기준선 `0.3` → 이번 `0.5` · `evaluation-live-l2-4` — 조건이 다르다: acceptance_cut: 기준선 `0.3` → 이번 `0.5` · `evaluation-live-l2-3` — 조건 지문이 확인되지 않는다(미상 11개: label_version, retrieval_labels_version, abstention_gate_statistic 외 8개) · `evaluation-live-l2-2` — 조건 지문이 확인되지 않는다(미상 11개: label_version, retrieval_labels_version, abstention_gate_statistic 외 8개) · `evaluation-live-l2-1` — 조건 지문이 확인되지 않는다(미상 11개: label_version, retrieval_labels_version, abstention_gate_statistic 외 8개)) · 기준선에 귀인 절이 없어 **근거 부분 손실 검사가 돌지 않았다** · 이번 실측에 귀인 절이 없어 **근거 부분 손실 검사가 돌지 않았다** · 두 세트에 공통으로 실린 케이스가 없어 **케이스 단위 판정이 돌지 않았다**. 아래 항목은 잠정 관측이다.
- 기준선 산출물: `evaluation-live-l2-13`, `evaluation-live-l2-14`, `evaluation-live-l2-15`
- 기준선 출처: `reports/ 자동 탐색`
- 선언된 실험 변인(대조 진행): judge_prompt_version: 기준선 `judge-e26f6c8e0b84` → 이번 `judge-7fad677f9ac6`
...
- 참고: 선언된 실험 변인이 있어 대조를 진행한다 — 차이: judge_prompt_version: 기준선 `judge-e26f6c8e0b84` → 이번 `judge-7fad677f9ac6`
- 참고: 측정 3 은 무변경 검사 대상이 아니다 — 판정 층 개선의 성공이 무관한 축의 원복을 발동시키면 안 되기 때문이다. 기준선 100.0% / 이번 100.0% — 두 세트의 값이 같다.
- 참고: 합산 일치율은 하한 경보선이고 사이클 판정은 케이스 단위가 맡는다.
