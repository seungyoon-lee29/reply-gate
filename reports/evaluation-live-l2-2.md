...
- 실행 시각(UTC): `2026-08-06T16:38:34+00:00`
...
| 측정 2 허용 결과 집합 대비 일치율 | ≥ 75% | 90.0% | 달성 |
...
- 골든셋 30건 처리
- **허용 결과 집합 대비 일치율: 90.0%** (27/30) — **초안 전 인계 경로 포함이며 L1 판정만의 지표가 아니다.**
- **기각 유발 문의의 기각 재현율: 40.0%** (2/5)
- 정상 PII 에코 감시 케이스: 1건 중 금지 사유 발화 0건
- 지연 p50: 12281 ms / p95: 25458 ms (파이프라인 `run` 의 벽시계 시간 — 처리 기록 저장은 포함하지 않는다)
...
- 판정 토큰: 입력 28861 / 출력 5854 (픽스처당 3155.9)
