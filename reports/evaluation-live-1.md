...
- 실행 시각(UTC): `2026-08-05T02:25:36+00:00`
...
- 골든셋 30건 처리
- **허용 결과 집합 대비 일치율: 73.3%** (22/30) — **초안 전 인계 경로 포함이며 L1 판정만의 지표가 아니다.**
- **기각 유발 문의의 기각 재현율: 20.0%** (1/5)
- 정상 PII 에코 감시 케이스: 1건 중 금지 사유 발화 0건
- 지연 p50: 4436 ms / p95: 9279 ms (파이프라인 `run` 의 벽시계 시간 — 처리 기록 저장은 포함하지 않는다)
