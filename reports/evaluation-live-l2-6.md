...
- 실행 시각(UTC): `2026-08-13T16:26:56+00:00`
...
- 지연 p50: 9691 ms / p95: 20930 ms (파이프라인 `run` 의 벽시계 시간 — 처리 기록 저장은 포함하지 않는다)
...
- `G04`: 없음
- `G05`: `policy:support:4-3`, `policy:support:4-4`, `policy:support:4-5`, `policy:support:4-2`
...
- `G09`: `sql:ae188bb8-600a-49dd-a53e-51c0caa2d996:1`
- `G10`: `sql:08aebf47-1cf1-4c1a-8463-1039b2432263:1`
- `G11`: `sql:866ad83b-f734-441a-84ed-6f29a21a4440:1`
- `G12`: `policy:refund:2-4`, `policy:support:4-3`, `policy:refund:2-1`, `policy:refund:2-6`, `policy:refund:2-2`, `sql:5ba70d7e-07e8-4466-aac3-ac55630f7455:1`
- `G13`: `sql:00ae5d45-66b2-449a-978b-c0593c7ed666:1`
- `G14`: `sql:405d7b61-46a3-4955-bb30-01aaee638501:1`
- `G15`: `policy:refund:2-5`, `policy:exchange:3-3`, `sql:2a7cd4ff-da4f-486c-838e-e12ff22ae14b:1`
...
- `G21`: `policy:shipping:1-6`, `policy:shipping:1-4`, `policy:shipping:1-1`, `policy:shipping:1-2`, `policy:exchange:3-2`
- `G22`: 없음
- `G23`: 없음
- `G24`: 없음
- `G25`: 없음
...
- `G27`: 없음
- `G28`: 없음
- `G29`: `sql:14290c0a-e25b-4989-b2ea-bb6fefe3cdb9:1`
- `G30`: `sql:23aa0b34-a98c-4227-adcf-6bc6431107fc:1`
...
- 근거 없이 답변 확정: **8건** — 정답 조항이 빠진 채 게이트를 통과했다
...
- `G02`: **생성 문제** — 정답 근거 `policy:shipping:1-3`, `policy:shipping:1-4` / 채택 근거 `policy:shipping:1-4`, `policy:shipping:1-3`, `policy:shipping:1-7`, `policy:shipping:1-6`
- `G04`: **검색 실패(전부 누락)** — 정답 근거 `policy:support:4-6` / 채택 근거 없음
- `G09`: **근거 없이 답변 확정** — 정답 근거 `policy:shipping:1-5` / 채택 근거 `sql:ae188bb8-600a-49dd-a53e-51c0caa2d996:1`
- `G10`: **근거 없이 답변 확정** — 정답 근거 `policy:shipping:1-5` / 채택 근거 `sql:08aebf47-1cf1-4c1a-8463-1039b2432263:1`
- `G11`: **근거 없이 답변 확정** — 정답 근거 `policy:shipping:1-1` / 채택 근거 `sql:866ad83b-f734-441a-84ed-6f29a21a4440:1`
- `G13`: **근거 없이 답변 확정** — 정답 근거 `policy:refund:2-4` / 채택 근거 `sql:00ae5d45-66b2-449a-978b-c0593c7ed666:1`
- `G14`: **근거 없이 답변 확정** — 정답 근거 `policy:exchange:3-5` / 채택 근거 `sql:405d7b61-46a3-4955-bb30-01aaee638501:1`
- `G16`: **생성 문제** — 정답 근거 `policy:support:4-1` / 채택 근거 `policy:support:4-1`, `policy:support:4-2`, `policy:support:4-5`, `policy:support:4-4`, `policy:support:4-3`
- `G18`: **근거 없이 답변 확정** — 정답 근거 `policy:refund:2-4`, `policy:refund:2-6` / 채택 근거 `policy:refund:2-6`
- `G21`: **빈 정답 정상 인계** — 정답 근거 없음 / 채택 근거 `policy:shipping:1-6`, `policy:shipping:1-4`, `policy:shipping:1-1`, `policy:shipping:1-2`, `policy:exchange:3-2` / 근거 채택 후 L2 검출
...
- `G29`: **근거 없이 답변 확정** — 정답 근거 `policy:support:4-5` / 채택 근거 `sql:14290c0a-e25b-4989-b2ea-bb6fefe3cdb9:1`
- `G30`: **검색 실패(전부 누락)** — 정답 근거 `policy:support:4-5` / 채택 근거 `sql:23aa0b34-a98c-4227-adcf-6bc6431107fc:1`
...
- 판정 토큰: 입력 29928 / 출력 5220 (픽스처당 3195.3)
