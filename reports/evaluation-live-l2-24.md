...
- 실행 시각(UTC): `2026-08-19T09:15:42+00:00`
- 생성 LLM: 미실행
- 임베딩: 미실행
...
- 판정 토큰: 입력 30042 / 출력 4443 (픽스처당 3135.0)
...
- 이번 실측 세트: 3/3회 `evaluation-live-l2-22`, `evaluation-live-l2-23`, `evaluation-live-l2-24`
...
- 사유: 판정 보류 — 기준선에 귀인 절이 없어 **근거 부분 손실 검사가 돌지 않았다** · 이번 실측에 귀인 절이 없어 **근거 부분 손실 검사가 돌지 않았다** · 두 세트에 공통으로 실린 케이스가 없어 **케이스 단위 판정이 돌지 않았다**. 아래 항목은 잠정 관측이다.
